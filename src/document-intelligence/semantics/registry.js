...
const SEMANTIC_RULES = deepFreeze([
  ...
  rule({ id: 'LAND_PURCHASE_PRICE', key: 'transaction.purchase_price', valueType: 'NUMBER', unit: 'SAR', normalization: NORMALIZATION.NUMBER, materiality: MATERIALITY.MATERIAL, aliases: ['قيمة الأرض', 'سعر شراء الأرض'], numericTolerance: { absolute: 1, relative: 0.000001 } }),
