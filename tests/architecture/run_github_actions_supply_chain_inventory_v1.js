...
const critical = new Set([
  ...
  '.github/workflows/inspection-measurement-verify.yml',
  '.github/workflows/investment-financing-metrics-verify.yml',
  ...
  '.github/workflows/release-governance-verify.yml',
]);
